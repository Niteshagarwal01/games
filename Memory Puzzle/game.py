...
for img in range(1,21):
	image = pygame.image.load(get_path(f"Assets/icons/{img}.jpeg"))
	image = pygame.transform.scale(image, (TILESIZE,TILESIZE))
	img_list.append(image)

bg = pygame.image.load(get_path('Assets/bg.jpg'))
game_won = pygame.image.load(get_path('Assets/won.png'))
rightbar = pygame.image.load(get_path('Assets/image.jpg'))
rightbar = pygame.transform.scale(rightbar, (280, HEIGHT - 47))

### Loading Sounds ************************************************************
pygame.mixer.music.load(get_path('Sounds/Puzzle-Game-3_Looping.mp3'))
pygame.mixer.music.set_volume(0.4)
pygame.mixer.music.play(loops=-1)

card_click = pygame.mixer.Sound(get_path("Sounds/card click.wav"))
woosh = pygame.mixer.Sound(get_path("Sounds/woosh.mp3"))

### Buttons *******************************************************************
restart_img = pygame.image.load(get_path('Assets/restart.png'))
restart_btn = Button(restart_img, (40,40), 720, 230)

info_img = pygame.image.load(get_path('Assets/info.png'))
info_btn = Button(info_img, (40,40), 720, 280)

close_img = pygame.image.load(get_path('Assets/close.png'))
close_btn = Button(close_img, (40,40), 720, 330)

### LOADING FRUITS INFORMATION ************************************************
with open(get_path('Info/info.json')) as f:
	dct = json.load(f)
