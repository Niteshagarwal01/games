...
# Add the current directory to the system path to ensure modules can be found
...
target_tile_fx = pygame.mixer.Sound(get_path('Sounds/target.mp3'))
empty_tile_fx = pygame.mixer.Sound(get_path('Sounds/empty.mp3'))
deadly_tile_fx = pygame.mixer.Sound(get_path('Sounds/dead.mp3'))
dash_fx = pygame.mixer.Sound(get_path('Sounds/dash.mp3'))
score_page_fx = pygame.mixer.Sound(get_path('Sounds/score_page.mp3'))

pygame.mixer.music.load(get_path('Sounds/cbpd.mp3'))
