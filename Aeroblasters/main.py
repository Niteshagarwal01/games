...
plane_img = pygame.image.load(get_path('Assets/plane.png'))
logo_img = pygame.image.load(get_path('Assets/logo.png'))
fighter_img = pygame.image.load(get_path('Assets/fighter.png'))
clouds_img = pygame.image.load(get_path('Assets/clouds.png'))
clouds_img = pygame.transform.scale(clouds_img, (WIDTH, 350))

home_img = pygame.image.load(get_path('Assets/Buttons/homeBtn.png'))
replay_img = pygame.image.load(get_path('Assets/Buttons/replay.png'))
sound_off_img = pygame.image.load(get_path("Assets/Buttons/soundOffBtn.png"))
sound_on_img = pygame.image.load(get_path("Assets/Buttons/soundOnBtn.png"))
...
game_over_font = get_path('Fonts/ghostclan.ttf')
tap_to_play_font = get_path('Fonts/BubblegumSans-Regular.ttf')
score_font = get_path('Fonts/DalelandsUncialBold-82zA.ttf')
final_score_font = get_path('Fonts/DroneflyRegular-K78LA.ttf')
...
player_bullet_fx = pygame.mixer.Sound(get_path('Sounds/gunshot.wav'))
click_fx = pygame.mixer.Sound(get_path('Sounds/click.mp3'))
collision_fx = pygame.mixer.Sound(get_path('Sounds/mini_exp.mp3'))
blast_fx = pygame.mixer.Sound(get_path('Sounds/blast.wav'))
fuel_fx = pygame.mixer.Sound(get_path('Sounds/fuel.wav'))

pygame.mixer.music.load(get_path('Sounds/Defrini - Spookie.mp3'))
