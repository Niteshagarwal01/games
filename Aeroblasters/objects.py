...
class Background():
	def __init__(self, win):
		...
		self.image = pygame.image.load(get_path('Assets/bg.png'))
...
class Player:
	def __init__(self, x, y):
		...
		self.image_list = []
		for i in range(2):
			img = pygame.image.load(get_path(f'Assets/player{i+1}.png'))
...
class Enemy(pygame.sprite.Sprite):
	def __init__(self, x, y, type_):
		...
		for i in range(2):
			if type_ == 1:
				img = pygame.image.load(get_path(f'Assets/Enemies/enemy1-{i+1}.png'))
			if type_ == 2:
				img = pygame.image.load(get_path(f'Assets/Enemies/enemy2-{i+1}.png'))
			if type_ == 3:
				img = pygame.image.load(get_path(f'Assets/Enemies/enemy3-{i+1}.png'))
			if type_ == 4:
				img = pygame.image.load(get_path(f'Assets/Choppers/chopper1-{i+1}.png'))
			if type_ == 5:
				img = pygame.image.load(get_path(f'Assets/Choppers/chopper2-{i+1}.png'))
		...
		if self.type in (1,2,3):
			self.fx = pygame.mixer.Sound(get_path('Sounds/plane.mp3'))
		elif self.type in (4, 5):
			self.fx = pygame.mixer.Sound(get_path('Sounds/chopper.mp3'))
...
class Bullet(pygame.sprite.Sprite):
	def __init__(self, x, y, type_, dx=None):
		...
		if type_ == 1:
			self.image = pygame.image.load(get_path('Assets/Bullets/1.png'))
			self.image = pygame.transform.scale(self.image, (20, 40))
		if type_ == 2:
			self.image = pygame.image.load(get_path('Assets/Bullets/2.png'))
			self.image = pygame.transform.scale(self.image, (15, 30))
		if type_ == 3:
			self.image = pygame.image.load(get_path('Assets/Bullets/3.png'))
			self.image = pygame.transform.scale(self.image, (20, 40))
		if type_ in (4, 5):
			self.image = pygame.image.load(get_path('Assets/Bullets/4.png'))
			self.image = pygame.transform.scale(self.image, (20, 20))
		if type_ == 6:
			self.image = pygame.image.load(get_path('Assets/Bullets/red_fire.png'))
			self.image = pygame.transform.scale(self.image, (15, 30))
...
class Explosion(pygame.sprite.Sprite):
	def __init__(self, x, y, type_):
		...
		for i in range(self.length):
			img = pygame.image.load(get_path(f'Assets/Explosion{type_}/{i+1}.png'))
			w, h = img.get_size()
			width = int(w * 0.40)
			height = int(w * 0.40)
...
class Fuel(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		self.image = pygame.image.load(get_path('Assets/fuel.png'))
		self.rect = self.image.get_rect(center=(x, y))
...
class Powerup(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		self.image = pygame.image.load(get_path('Assets/powerup.png'))
		self.rect = self.image.get_rect(center=(x, y))
