...
flip_fx = pygame.mixer.Sound(get_path('Sounds/flip.mp3'))
score_fx = pygame.mixer.Sound(get_path('Sounds/point.mp3'))
dead_fx = pygame.mixer.Sound(get_path('Sounds/dead.mp3'))
score_page_fx = pygame.mixer.Sound(get_path('Sounds/score_page.mp3'))

pygame.mixer.music.load(get_path('Sounds/bgm.mp3'))
...
score_font = get_path("Fonts/DroneflyRegular-K78LA.ttf")
game_over_font = get_path("Fonts/ghostclan.ttf")
final_score_font = get_path("Fonts/DalelandsUncialBold-82zA.ttf")
new_high_font = get_path("Fonts/BubblegumSans-Regular.ttf")
...
home_img = pygame.image.load(get_path('Assets/homeBtn.png'))
replay_img = pygame.image.load(get_path('Assets/replay.png'))
sound_off_img = pygame.image.load(get_path("Assets/soundOffBtn.png"))
sound_on_img = pygame.image.load(get_path("Assets/soundOnBtn.png"))
easy_img = pygame.image.load(get_path("Assets/easy.jpg"))
hard_img = pygame.image.load(get_path("Assets/hard.jpg"))
