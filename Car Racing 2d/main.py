...
bg = pygame.image.load(get_path('Assets/bg.png'))

home_img = pygame.image.load(get_path('Assets/home.png'))
play_img = pygame.image.load(get_path('Assets/buttons/play.png'))
end_img = pygame.image.load(get_path('Assets/end.jpg'))
end_img = pygame.transform.scale(end_img, (WIDTH, HEIGHT))
game_over_img = pygame.image.load(get_path('Assets/game_over.png'))
game_over_img = pygame.transform.scale(game_over_img, (220, 220))
coin_img = pygame.image.load(get_path('Assets/coins/1.png'))
dodge_img = pygame.image.load(get_path('Assets/car_dodge.png'))

left_arrow = pygame.image.load(get_path('Assets/buttons/arrow.png'))
right_arrow = pygame.transform.flip(left_arrow, True, False)

home_btn_img = pygame.image.load(get_path('Assets/buttons/home.png'))
replay_img = pygame.image.load(get_path('Assets/buttons/replay.png'))
sound_off_img = pygame.image.load(get_path("Assets/buttons/soundOff.png"))
sound_on_img = pygame.image.load(get_path("Assets/buttons/soundOn.png"))

cars = []
car_type = 0
for i in range(1, 9):
	img = pygame.image.load(get_path(f'Assets/cars/{i}.png'))
...
nitro_counter = 0
for i in range(6):
	img = pygame.image.load(get_path(f'Assets/nitro/{i}.gif'))
...
click_fx = pygame.mixer.Sound(get_path('Sounds/click.mp3'))
fuel_fx = pygame.mixer.Sound(get_path('Sounds/fuel.wav'))
start_fx = pygame.mixer.Sound(get_path('Sounds/start.mp3'))
restart_fx = pygame.mixer.Sound(get_path('Sounds/restart.mp3'))
coin_fx = pygame.mixer.Sound(get_path('Sounds/coin.mp3'))

pygame.mixer.music.load(get_path('Sounds/mixkit-tech-house-vibes-130.mp3'))
